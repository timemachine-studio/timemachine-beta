...
function generateImageUrl(params: ImageGenerationParams): string {
  ...
  let url = `https://enter.pollinations.ai/api/generate/image/${encodedPrompt}?width=${width}&height=${height}&enhance=false&private=true&nologo=true&model=nanobanana&key=${hardcodedToken}`;
